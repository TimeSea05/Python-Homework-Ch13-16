...
def update_bullets(bullets, screen_rect, rect, ai_settings):
    """更新子弹的位置，并删除已经消失的子弹"""
    # 更新子弹的位置
    bullets.update()
    ...
    check_collision(bullets, rect, ai_settings)


def check_collision(bullets, rect, ai_settings):
    if pygame.sprite.spritecollideany(rect, bullets):
        ...
        ai_settings.rect_speed_factor *= 1.5
...
def check_play_button(ai_settings, screen, stats, play_button, bullets, ship,
    ...
    if button_clicked and not stats.game_active:
        ...
        ai_settings.rect_speed_factor = 1
